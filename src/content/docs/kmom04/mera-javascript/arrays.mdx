...
Ta bort och returnera sista respektive första värdet:
```js
let arr1 = [1, 2, 3]
let lastValue = arr1.pop() // removes and returns last value

console.log(lastValue) // 3
console.log(arr1) // [ 1, 2 ]

let firstValue = arr1.shift() // removes and returns first value
