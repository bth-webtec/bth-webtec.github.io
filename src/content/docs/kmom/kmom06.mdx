...
1. Jobba igenom artikeln om "[objekt literaler](/laromaterial/ovning/object-och-mer-fetch/objectliteral/)".

1. Jobba igenom artikeln om "[fetch image](/laromaterial/ovning/object-och-mer-fetch/fetchimage/)".

1. Jobba igenom artikeln om "[JSON](/laromaterial/ovning/object-och-mer-fetch/json/)".

1. Jobba igenom artikeln om "[input elements](/laromaterial/ovning/formelements/)".
