...
Labbmiljön bygger främst på verktyg som är fria och ofta erbjuds i form av öppen källkod. Du behöver installera hela labbmiljön innan du kan påbörja det första kursmomentet.
