...
description: "Lär dig grunderna i HTML, CSS (och JavaScript)."
revision:
...
Vi börjar med att bygga en enkel webbplats med grunderna i HTML, CSS och JavaScript. Vi skapar en god struktur och uppdelning av filer och kataloger som förbereder oss för större projekt. Vi lär oss grundläggande begrepp som används när man bygger en webbplats.
...
1. [Introduktion till Webbteknologier](./introduktion-till-webbteknologier)
1. [Introduktion till HTML](./introduktion-till-html)
...
1. Jobba igenom övningen "[Skapa en webbsida med HTML, CSS och JavaScript](./skapa-en-webbsida-med-html-css-och-javascript)" som hjälper dig att komma igång och stegvis bygga en webbplats med HTML, CSS och JavaScript.

1. Gå igenom artikeln om [inbyggda typer](./kom-igang-med-javascript/builtin-types) i JavaScript.

{/*
 1. Gå igenom artikeln om [de vanligaste konstruktionerna del 1](/ovning/kom-igang-med-javascript/common-structures-1) i JavaScript.
*/}
...
1. Utför laborationen "[Lab 1: Grunderna i JavaScript](./lab_01/)".

1. Gör uppgiften "[Bygg webbsidor med HTML, CSS och JavaScript](./bygg-webbplats/)".
